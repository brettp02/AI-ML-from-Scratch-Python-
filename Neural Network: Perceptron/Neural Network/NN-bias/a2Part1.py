...
if __name__ == '__main__':
    ...
    initial_bias_weights = np.array([-0.02,-0.20,-0.33,0.26,0.06])

    nn = Neural_Network(n_in, n_hidden, n_out, initial_hidden_layer_weights, initial_output_layer_weights, initial_bias_weights,
                        learning_rate)
    ...
    #nn.train(instances, onehot_encoded, epochs=1)
    ...
    # TODO: Compute and print the test accuracy(Complete)
